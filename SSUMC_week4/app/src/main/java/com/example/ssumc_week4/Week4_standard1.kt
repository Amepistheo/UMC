...
import com.example.ssumc_week4.databinding.ActivityWeek4Standard1Binding

class Week4_standard1 : AppCompatActivity () {
    private lateinit var viewBinding: ActivityWeek4Standard1Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        Toast.makeText(this, "onCreate", Toast.LENGTH_SHORT).show()

        viewBinding = ActivityWeek4Standard1Binding.inflate(layoutInflater)
        setContentView(viewBinding.root)

        var edtMain = viewBinding.edtMain

        viewBinding.btnMain.setOnClickListener{
            val intent = Intent(this, Week4_standard2::class.java)
